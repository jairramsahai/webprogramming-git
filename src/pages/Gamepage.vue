<template>
    <div>
      ...
      <div v-for="(vote, index) in votes" :key="index">
          <button @click="addVote(vote.points)">
    ...
    export default {
        ...
        methods: {
            ...
            fetchArtists(songs) {
                ...
                fetch(url)
                    ...
                    .then((artists) => {
                        ...
                        //change data of songs,everything will get rerendered
                        this.songs = songs;
                    });
            },
            ...
            addVote(points)
            {
                ...
                //create new array when points is equal to given points, change isVoted state so it dissapaears
                votes.map((vote) => {
